          ...
          <table>
            <tbody>
              <tr>
                <th>Harakatlar</th>
                <td>
                  <button onClick={this.handleStop}>To'xtatish</button>
              ...
              <tr>
                <th>
                  <label htmlFor="muted">Ovozni o'chirish</label>
                </th>
                <td>
                  <input
                    id="muted"
              ...
              <tr>
                <th>
                  <label htmlFor="loop">Qayta ijro</label>
                </th>
                <td>
                  <input
                    id="loop"
              ...
              <tr>
                <th>Qancha ijro etildi</th>
                <td>
                  <progress max={1} value={played} />
                </td>
              </tr>
              <tr>
                <th>Qancha yuklandi</th>
                <td>
